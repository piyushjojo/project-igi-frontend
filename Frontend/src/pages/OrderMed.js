    ...
    <div>
      <Navbar2 page="order"/>
              ...
              <div className="container">
                <div className="w-100 d-flex flex-wrap align-items-center justify-content-center">
                  ...
                  <div className="text-end">
                    <button disabled={name ? false : true} type="button"  onClick={handleClick} className="btn  me-2 btn-primary">
          ...
          <div className="text-center mb-6">
            <Link  to="/cart"><button className="btn btn-primary">Go to Cart  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
