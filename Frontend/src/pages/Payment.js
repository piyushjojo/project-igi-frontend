    ...
    return(
        <div>
            ...
            <div className="row m-4" style={{ textAlign: "right" }}>
                ...
                <Link to="/wallet" >
                    <button className="btn btn-dark my-4" style={{ textAlign: "right"}} id="walletBtn" hidden="true">Add to Wallet</button>
                </Link>
            </div>
                            ...
                            <div className="card-body">
                                ...
                                <table className="table border-borderless">
                                    ...
                                    <tr style={{ borderTop: "0px" }}>
                                        ...
                                        <td style={{ "textAlign": "end" }}>Rs. {paymentDto.orderAmount}</td>
                                    </tr>
                                </table>
