      ...
      <div className="container-fluid">
        <div className="row justify-content-center">
          <div
            ...
            style={{ width: "30rem", marginTop: "4%" }}
          >
            <div className="card-body">
              <h4 className="card-title text-success">Your Order Confirmed!</h4>
              <p className="card-text">
                Hi {order_summary.order.patient.name},
              </p>
              <p className="card-text">
                Your order <b>has been confirmed</b> and will be shipping soon.
              </p>
              <p className="card-text text-success">
                <i>Email sent to your registered Email Address......</i>
                <p className="card-text text-dark">
                  <b> {order_summary.order.patient.email}</b>
                </p>
              </p>
              <hr></hr>
